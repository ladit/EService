      ...
      <div class="main-cover">
        ...
        <div class="main-right">
			...
			<form class="form-header">
				...
				<div class="form-group last">
					<input type="button" class="btn btn-warning btn-block btn-lg" value="注册" onclick="window.location='register.php'">
				</div>
				<div class="form-group last">
...
<script type="text/javascript">
	...
	function login()
	{
		...
		xhr.open('POST', 'functions/action.php?action=enterpriseLogin', true);
		...
		xhr.onreadystatechange = function()
		{
			if(xhr.readyState==4 && xhr.status==200)
			{
				...
				{
					window.location.href="company/co-manage-center.php";
				}
				else {
