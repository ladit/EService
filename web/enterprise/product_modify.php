      ...
      <div class="container-right">
        <div class="panel panel-default">
          <div class="panel-heading">
			主页 > <a href="product_manage.php">产品库</a> > 产品修改
		  </div>
          <div class="panel-body">
            <div class="pro-list">
              ...
              <div class="pro-list-body">
                <div class="pro-add">
                  <form action="../functions/action.php?action=modifyProduct" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="pro-add-right">
                      <div class="form-group">
						...
						<input type="file" id="PImage"  name="PImage"  value="../functions/action.php?action=showProductImage&PID=<?=$_GET['PID']?>">
