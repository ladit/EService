...
<script type="text/javascript">
    function check()
    {
        ...
        else
        {
		    ...
		    xhr.send('inputLoginName='+inputLoginName+'&inputPassword='+inputPassword+'&inputName='+inputName+'&inputLegalPerson='+inputLegalPerson+'&inputLegalPersonID='+inputLegalPersonID+'&inputCaptcha='+inputCaptcha);
